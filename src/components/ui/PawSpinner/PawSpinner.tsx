...
import classes from './PawSpinner.module.css';
...
export const PawSpinner: FC<PawSpinnerProps> = ({ size = DEFAULT_SIZE, pawColor = 'var(--color-gray)', className }) => {
  return (
    <div
      role='status'
      aria-label='Loading'
